...
def main(folderpath,k):
    ...
    for img_path in file_list:
        ...
        # load model weights
        model_weight_path = "./weights5/best_model.pth"
    ...
    csv_file_path = os.path.join('./predict_result5', str(k)+'.csv')
    df.to_csv(csv_file_path, index=False)


if __name__ == '__main__':
    oripath = '/home/sx91/Transformation/deep-learning-for-image-processing-master/data_set/Cer/test'
    if os.path.exists("./predict_result5") is False:
        os.makedirs("./predict_result5")
